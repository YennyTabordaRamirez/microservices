package microservice.store2.serviceproduct2.controller;
...
;        if(null == categoryId){
    ...
    public  ResponseEntity<Product> updateStockProduct
        ...
        Product productStockDb = productService.updateStock(id, quantity);
        if(null == productStockDb){
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok(productStockDb);
    }
